% PlotDistancesVsAlpha.m  (FigureScripts/)
%
% Loads a precomputed distance dataset and plots how mean Euclidean
% distances between different cluster groups evolve as a function of the
% cue strength parameter alpha. Produces three figures:
%   1. Raw mean distances for five group pairs (intra-m, intra-rnd,
%      inter m-vs-m, m-vs-rnd, rnd-vs-rnd) vs alpha.
%   2. Inter/Intra ratio (normalized by intra-rnd) for m-vs-rnd and
%      rnd-vs-rnd.
%   3. All distances normalized relative to intra-memory distance.
%
% Requires: distancesDataSet.mat (contains 'dictionary' keyed by alpha)
% Run from: the Part3(ClassificationSequential) root directory.
% Parameters: N=400, nMems=25
